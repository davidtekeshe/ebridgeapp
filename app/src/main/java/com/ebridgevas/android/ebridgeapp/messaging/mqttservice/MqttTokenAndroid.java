...
import com.ebridgevas.android.ebridgeapp.messaging.mqttv3.IMqttAsyncClient;
...
class MqttTokenAndroid implements IMqttToken {
  ...
  /**
   * @see com.ebridgevas.android.ebridgeapp.messaging.mqttv3.IMqttToken#waitForCompletion()
   */
  @Override
  ...
  /**
   * @see com.ebridgevas.android.ebridgeapp.messaging.mqttv3.IMqttToken#waitForCompletion(long)
   */
  @Override
  ...
  /**
   * @see com.ebridgevas.android.ebridgeapp.messaging.mqttv3.IMqttToken#isComplete()
   */
  @Override
  ...
  /**
   * @see com.ebridgevas.android.ebridgeapp.messaging.mqttv3.IMqttToken#getException()
   */
  @Override
  ...
  /**
   * @see com.ebridgevas.android.ebridgeapp.messaging.mqttv3.IMqttToken#getClient()
   */
  @Override
  ...
  /**
   * @see com.ebridgevas.android.ebridgeapp.messaging.mqttv3.IMqttToken#setActionCallback(IMqttActionListener)
   */
  @Override
  ...
  /**
   * @see com.ebridgevas.android.ebridgeapp.messaging.mqttv3.IMqttToken#getActionCallback()
   */
  @Override
  ...
  /**
   * @see com.ebridgevas.android.ebridgeapp.messaging.mqttv3.IMqttToken#getTopics()
   */
  @Override
  ...
  /**
   * @see com.ebridgevas.android.ebridgeapp.messaging.mqttv3.IMqttToken#setUserContext(Object)
   */
  @Override
  ...
  /**
   * @see com.ebridgevas.android.ebridgeapp.messaging.mqttv3.IMqttToken#getUserContext()
   */
  @Override
  ...
  /**
   * @see com.ebridgevas.android.ebridgeapp.messaging.mqttv3.IMqttToken#getMessageId()
   */
  @Override
