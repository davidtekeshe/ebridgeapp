...
import com.ebridgevas.android.ebridgeapp.renderers.dagger.exception.NullRendererBuiltException;

import java.util.Collection;

/**
 * RecyclerView.Adapter extension created to work RendererBuilders and Renderer instances. Other
 * adapters have to use this one to show information in RecyclerView widgets.
 *
