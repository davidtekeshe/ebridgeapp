...
public class ParticipantContentProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        // Set the table
        queryBuilder.setTables(ParticipantContract.ParticipantEntry.TABLE_NAME);
        ...
        switch (uriType) {
            ...
            case MARKET_ID:
                ...
                queryBuilder.appendWhere(ParticipantContract.ParticipantEntry.COLUMN_NAME_PARTICIPANT_ID + "="
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriType) {
            case MARKET:
                id = sqlDB.insert(ParticipantContract.ParticipantEntry.TABLE_NAME, null, values);
                break;
            default:
                throw new IllegalArgumentException("Unknown URI: " + uri);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriType) {
            case MARKET:
                rowsDeleted = sqlDB.delete(ParticipantContract.ParticipantEntry.TABLE_NAME, selection, selectionArgs);
                break;
            case MARKET_ID:
                ...
                if (TextUtils.isEmpty(selection)) {
                    rowsDeleted = sqlDB.delete(
                            ...
                            ParticipantContract.ParticipantEntry.COLUMN_NAME_PARTICIPANT_ID + "=" + id, null);
                } else {
                    rowsDeleted = sqlDB.delete(ParticipantContract.ParticipantEntry.TABLE_NAME,
                            ParticipantContract.ParticipantEntry.COLUMN_NAME_PARTICIPANT_ID + "=" + id +
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (uriType){
            case MARKET:
                rowsUpdated = sqlDB.update(ParticipantContract.ParticipantEntry.TABLE_NAME, values, selection, selectionArgs);
                break;
            case MARKET_ID:
                String id = uri.getLastPathSegment();
                if (TextUtils.isEmpty(selection)) {
                    rowsUpdated = sqlDB.update(ParticipantContract.ParticipantEntry.TABLE_NAME, values,
                            ParticipantContract.ParticipantEntry.COLUMN_NAME_PARTICIPANT_ID + "=" + id, null);
                } else {
                    rowsUpdated = sqlDB.update(ParticipantContract.ParticipantEntry.TABLE_NAME,
                            values, ParticipantContract.ParticipantEntry.COLUMN_NAME_PARTICIPANT_ID + "=" + id +
                            " and " + selection, selectionArgs);
                }
                break;
            default:
    ...
    private void checkColumns(String[] projection) {
        String[] available = {
                ...
                ParticipantContract.ParticipantEntry.COLUMN_NAME_MARKET_CLASS_ID,
                ParticipantContract.ParticipantEntry.COLUMN_NAME_MARKET_TYPE_ID,
                ParticipantContract.ParticipantEntry.COLUMN_NAME_PARTICIPANT_NAME,
                ParticipantContract.ParticipantEntry.COLUMN_NAME_ODDS,
