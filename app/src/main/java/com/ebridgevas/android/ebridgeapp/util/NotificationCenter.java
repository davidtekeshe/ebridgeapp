...
public class NotificationCenter {
    ...
    public static final int MESSAGE_RECEIVED = 998;
    public static final int PRODUCT_SELECTED = 997;
    public static final int MARKET_FEED_RECIVED = 996;
    public static final int SEND_MESSAGE = 995;
