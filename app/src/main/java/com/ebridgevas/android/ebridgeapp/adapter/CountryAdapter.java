...
import com.ebridgevas.android.ebridgeapp.cells.DividerCell;
import com.ebridgevas.android.ebridgeapp.cells.LetterSectionCell;
import com.ebridgevas.android.ebridgeapp.cells.TextSettingsCell;
...
public class CountryAdapter extends BaseSectionsAdapter {
    ...
    public CountryAdapter(Context context) {
        ...
        try {
            InputStream stream = mContext.getResources().getAssets().open("countries.txt");
        ...
        Collections.sort(
                sortedCountries, new Comparator<String>() {
                    @Override
    ...
    public View getItemView(int section, int position, View convertView, ViewGroup parent) {
        ...
        if (type == 1) {
            if (convertView == null) {
                ...
                convertView.setPadding(AndroidUtilities.dp(72), 0, AndroidUtilities.dp(24), 0);
            }
        } else if (type == 0) {
            if (convertView == null) {
                convertView = new TextSettingsCell(mContext);
                convertView.setPadding(AndroidUtilities.dp(54), 0, AndroidUtilities.dp(16), 0);
            }
