//package com.ebridgevas.android.ebridgeapp.mqtt.service;
//
//import java.io.File;
...
//
//import com.ebridgevas.android.ebridgeapp.mqtt.impl.MqttConnectOptions;
//import com.ebridgevas.android.ebridgeapp.mqtt.impl.MqttException;
//import com.ebridgevas.android.ebridgeapp.mqtt.impl.MqttMessage;
//import com.ebridgevas.android.ebridgeapp.mqtt.impl.MqttPersistenceException;
//import com.ebridgevas.android.ebridgeapp.mqtt.impl.MqttTopic;
//import com.ebridgevas.android.ebridgeapp.mqtt.impl.paho.PahoMqttClientFactory;
...
//import com.ebridgevas.android.ebridgeapp.mqtt.logging.ConfigureLog4J;
//
///*
...
//    private String 					username			 = "27729745087";
//    private char[]					password			 = null; //"guest".toCharArray();
//
...
//    private String          mqttClientId = "27729745087";
//
//    /************************************************************************/
...
//        brokerHostName = "52.39.188.4";
//        topics.add(new MqttTopic("soccer"));
//
...
//
//        while ( !isConnected() && ( System.currentTimeMillis() < ( now + (15 * 1000) ) ) ) {
...
//            try
//            {
//                Log.i(TAG, "subscribing to ... " );
//                for (IMqttTopic topic : topics) {
//                    Log.i(TAG, "topic: " + topic.getName());
//                }
...
//            	Log.d(TAG,"subscribe failed - illegal argument", e);
//            } catch (MqttException e) {
//            	Log.d(TAG,"subscribe failed - MQTT exception", e);
//            }
//        } else {
//            Log.d(TAG,"Unable to subscribe as we are not connected");
//        }
//
//        if (subscribed == false)
//        {
...
//        	Log.d(TAG,"unregister failed", eee);
//        }
//
//        try
//        {
...
//        {
//        	Log.d(TAG,"disconnect failed - persistence exception", e);
//        }
//		catch (MqttException e)
//		{
//			Log.d(TAG,"disconnect failed - mqtt exception", e);
//		}
//        finally
//        {
//            mqttClient = null;
...
//			Log.d(TAG,"handlePublishMessageIntent: isOnline()="+isOnline+", isConnected()="+isConnected);
//			return;
//		}
//
...
//
//		try {
//			mqttClient.publish(new MqttTopic("soccer"), new MqttMessage(payload));
//		}
//		catch(MqttException e) {
...
//	                Log.d(TAG,"ping failed - MQTT exception", e);
//
...
//	                	Log.d(TAG,"disconnect failed - persistence exception", e1);
//	                }
//					catch (MqttException e2)
//					{
//						Log.d(TAG,"disconnect failed - mqtt exception", e2);
//					}
//
//	                // reconnect
