 ...
 */
package com.ebridgevas.android.ebridgeapp.messaging.mqttv3.logging;
 ...
 * replaced using {@link com.ebridgevas.android.ebridgeapp.messaging.mqttv3.logging.LoggerFactory#setLogger(String)}
 * which takes an implementation of the {@link com.ebridgevas.android.ebridgeapp.messaging.mqttv3.logging.Logger}
 * interface.
 */
public class LoggerFactory {
	 ...
	 */
	public final static String MQTT_CLIENT_MSG_CAT = "com.ebridgevas.android.ebridgeapp.messaging.mqttv3.internal.nls.logcat";
...
//		logger = getLogger(loggerClassName, ResourceBundle.getBundle(MQTT_CLIENT_MSG_CAT), loggerID, null );
//		}
//
//		if (null == logger) {
