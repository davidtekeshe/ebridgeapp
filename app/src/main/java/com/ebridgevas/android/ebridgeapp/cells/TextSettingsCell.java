    ...
    public TextSettingsCell(Context context) {
        ...
        addView(textView,
                LayoutHelper.createFrame(
                        LayoutHelper.MATCH_PARENT, LayoutHelper.MATCH_PARENT, Gravity.LEFT | Gravity.TOP, 17, 0, 17, 0));
        ...
        addView(valueImageView, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.RIGHT | Gravity.CENTER_VERTICAL, 17, 0, 17, 0));
    }
