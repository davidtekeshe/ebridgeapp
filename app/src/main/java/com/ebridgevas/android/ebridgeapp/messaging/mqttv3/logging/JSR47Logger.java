 ...
 * {@link com.ebridgevas.android.ebridgeapp.messaging.mqttv3.util.Debug Debug} provides method to make it easy
...
public class JSR47Logger implements Logger {
	 ...
	 * @param loggerID			The suffix for the loggerName (will be appeneded to com.ebridgevas.android.ebridgeapp.messaging.mqttv3
...
//		loggerName = "com.ebridgevas.android.ebridgeapp.messaging.mqttv3." + ((null == loggerID || 0 == loggerID.length()) ? "internal" : loggerID);
		loggerName = loggerID;
